...
class Project {
  ...
  static async create(projectData) {
    ...
    const result = await pool.query(
      `INSERT INTO projects 
       (project_name, description, technologies, github_link, demo_link, image, user_id) 
       VALUES ($1, $2, $3, $4, $5, $6, $7) 
       RETURNING id, project_name, description, technologies, github_link, demo_link,
                 CASE 
  ...
  static async update(id, projectData) {
    ...
    const result = await pool.query(
      `UPDATE projects 
       SET project_name = $1, description = $2, technologies = $3, 
           github_link = $4, demo_link = $5, 
           image = $6,
